...
import (
	...
	testdata "github.com/lemoba/go-sweet/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/lemoba/go-sweet/framework/gin.handlerNameTest$", c.HandlerName())
}
